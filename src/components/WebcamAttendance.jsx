      ...
      >
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"20px 18px", display:"flex", flexDirection:"column", alignItems:"center", gap:"16px" }}>
          ...
          {(() => {
            ...
            // Use the group invite link from Company Settings if available.
            // WhatsApp group invite links look like: https://chat.whatsapp.com/XXXXXXXXXX
            // We append the message via the wa.me share trick by opening the group link directly.
            // Note: WhatsApp does NOT support pre-filling text into a group via API —
            // so we open the group link first, then copy the message to clipboard.
            const groupLink = companySettings?.whatsappGroupLink?.trim();
            const hasGroupLink = groupLink && groupLink.startsWith("https://chat.whatsapp.com/");
            ...
            if (hasGroupLink) {
              // Group link is configured → copy message to clipboard, then open group
              return (
                <div style={{ width:"100%", display:"flex", flexDirection:"column", gap:"6px" }}>
                  ...
                  <p style={{ fontFamily:"Mulish,sans-serif", fontSize:"10px", color:isDark?"#555555":"#AAAAAA", textAlign:"center", lineHeight:1.4 }}>
                    Your attendance message is copied to clipboard — just paste it in the group.
                  </p>
                </div>
              );
            }

            // No group link → fallback: generic share (opens WhatsApp contact picker)
            return (
              <div style={{ width:"100%", display:"flex", flexDirection:"column", gap:"6px" }}>
                <a
                ...
                <p style={{ fontFamily:"Mulish,sans-serif", fontSize:"10px", color:"#C9922A", textAlign:"center", lineHeight:1.4 }}>
                  ⚠ No group link set. Admin: go to Settings → Company → WhatsApp Group to add it.
                </p>
              </div>
            );
          })()}
