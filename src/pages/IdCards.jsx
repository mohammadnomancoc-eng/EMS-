...
import { subscribeEmployees, subscribeIdCardTemplates, addNotification } from "../firebase/firestoreService";
    ...
    try {
      ...
      try {
        await addNotification({
          ...
          message: `Your corporate ID Card has been approved and generated by administration.`,
          type: "employee",
          targetId: emp.id,
          recipientId: emp.id,
          priority: "normal",
        ...
        console.error("Failed to add ID Card notification:", err);
      }
