...
export default function MyProfile() {
  ...
  async function handleChangePassword() {
    ...
    try {
      ...
      // Sync new password to the employee's Firestore doc so admin can see it
      const empId = storedUser.empId;
      if (empId) {
        try {
          await updateEmployee(empId, { loginPassword: pwForm.next });
          ...
          // Non-critical — don't block the success toast
        }
      }
